...
ログインユーザ:
  ...
  return "request/list";
        ...
        {
          type: "p",
          text: "ここまでの流れは、セッション作成 → Cookie 付与 → ID からの復元です。タイムアウトや Cookie の削除でセッションが切れると、この復元ができなくなり、ログイン情報なら未ログイン扱いになります。ログアウトも、タイムアウトを待たずにセッションを明示的に破棄する操作です。",
        },
        {
          type: "h2",
...
public String showCart(HttpSession session, Model model) {
  ...
  return "cart";
        ...
        {
          type: "p",
          text: "このキーの文字列がずれると、エラーにならないまま値が取り出せなくなります。実際にこれが起きた例は、「実務のシナリオ」の「申請履歴から詳細を開いて戻ると、検索条件が消える」で扱います。",
          link: {
