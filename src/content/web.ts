  ...
  lessons: [
    {
      ...
      blocks: [
        {
          type: "p",
          text: "URL を入力して Enter を押す、リンクをクリックする。ふだん何気なくしているその操作のたびに、裏側ではこんなやり取りが起きています。ブラウザは、インターネットの先にあるサーバというコンピュータへ何かを頼みます。サーバはそれに応え、結果を返します。ブラウザは、返ってきた中身をもとに画面を組み立てて表示します。",
        },
        {
          type: "p",
