...
mailService.notifyApplicant(request);`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "同じ SQL を検証用環境の DB で実行できるなら、コードを読むより早いことがあります。SELECT はそのまま試せます。UPDATE や DELETE を実行すると、共有している検証用環境のデータが本当に書き換わります。その環境を更新してよいか確認し、試すならトランザクションを始めて結果を見て ROLLBACK します。COMMIT はしません。",
        },
      ],
    },
    {
