  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: "探したい SQL が先にあるときは、テーブル名や特徴のある文の一部を手がかりにしましょう。MyBatis と JPA では探し方が違います。手順は「リクエストの追跡」の「SQL からソースを探す」です。",
        },
      ],
    },
    {
...
request.getApproverId().equals(userId); // NPE`,
        ...
        {
          type: "p",
          text: "変数への代入をソースで検索しても、呼び出し元が見つからないことも、見つかった行だけでは元の値に気づきにくいこともあります。よくある3パターンです。",
        },
        {
          type: "h3",
          text: "フレームワークが値を入れる",
  ...
  public void setCustomerName(String customerName) {
    this.customerName = customerName;
        ...
        {
          type: "p",
          text: "Entity から DTO（レスポンス用オブジェクトなど）へ詰め替えるとき、フィールド名が変わっていることがあります。詰め替えあとの名前で検索しても、詰め替えの1行から先（元のフィールド名）へはそのままでは辿れません。",
        },
        {
          type: "code",
