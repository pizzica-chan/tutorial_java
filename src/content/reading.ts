  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "note",
          title: "入口の手順の中でも検索する",
          text: "「処理の入口から読む」でも、パス文字列でソースを検索します。違いは、URL が取れていて「この操作の入口」を探すか、文言だけがあって「まず入口の場所を当てるか」です。",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "リポジトリを上から読む必要はありません。操作が特定できているときは、処理の入口だけを開き、そこから下へ降ります。手がかりの選び方は前のレッスンです。",
        },
        {
          type: "p",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "入口のクラス名がまだ分からないときは、画面に出ている語やログの名前から当てます。URL が取れたあとは、前のレッスンの「処理の入口から読む」に入ります。",
        },
        {
          type: "p",
