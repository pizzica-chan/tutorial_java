      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ["データ", "件数やマスタの増減。初めてその条件に当たったレコードが来ただけのこともある"],
...
9e0f2a1 2026-08-27 18:20 承認一覧のページングを追加`,
        ...
        },
        {
          ...
          link: {
            label: "Linux の基本操作",
            to: "/tracks/troubleshoot/linux-basics",
          },
        },
        {
          type: "p",
...
drwxr-xr-x 2 root root 4096 Aug 20 09:10 /var/log/shinsei`,
        ...
        },
        {
          ...
          rows: [
            ["`x`", "そのディレクトリの中の名前を引く。パスでファイルを指定する操作の前提になる"],
        ...
        {
          type: "p",
          text: "ファイルの作成と削除には、`w` と `x` の両方が必要です。`x` はパスの途中のすべてのディレクトリで要るので、ファイル自身が読める権限でも、上位のディレクトリのどこかに `x` が無ければ、そのファイルには届きません。",
        },
        {
          type: "h2",
          text: "プロセスとリソースを見る",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          link: {
            label: "ネットワークの疎通確認",
            to: "/tracks/troubleshoot/net-check",
          },
        },
        {
          type: "p",
...
2026-08-30 09:58:30.412 INFO  [main] j.c.e.shinsei.ShinseiApplication : The following 1 profile is active: "stg"`,
        ...
        },
        {
          ...
          text: "プロファイルの指定が、そのプロセスまで届いていません。起動引数や環境変数を渡したつもりでも、サービスやコンテナの設定を経由すると抜けることがあります。この行を見れば、指定が効いているかどうかが分かります。",
        },
        {
          type: "p",
