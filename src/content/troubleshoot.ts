      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              title: "再現する",
              text: "同じ操作をしましょう。再現できないなら、障害が起きたときと自分で試したときで、権限・データ・発生時刻の違いを控えておきましょう。",
            },
            {
              title: "当たりをつける",
        ...
        },
        {
          ...
          rows: [
            [
              ...
              "新しいリクエストが無ければサーバには届いていない。5xx、または 2xx でも本文がエラーなら、同時刻のサーバ側のエラーログ",
            ],
            [
              "見た目だけおかしい（色、レイアウト）",
            ...
            [
              ...
              "エラーログが無く 200 なら、処理は応答まで終わっている。おかしいのは読んだ行か条件",
            ],
            [
              "ボタンを押しても画面が変わらない",
...
<==      Total: 5`,
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "404 は 5xx ではなく、「その URL に対応する資源が無い」です。",
        },
        {
          type: "figure",
          kind: "screen",
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "画面は 200 で、エラーログも無い。データだけ期待と違う場合は SQL と、DB に入っている行を見ましょう。",
        },
        {
          type: "figure",
          kind: "screen",
          ...
          alt: "申請が 0 件の申請一覧",
          caption: "一覧は 200 で、表だけ空です。エラーログでは分からないので、実行された SQL とその条件の行を見ましょう。",
        },
        {
          type: "table",
          headers: ["症状", "確認"],
