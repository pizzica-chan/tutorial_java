      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: "どこまで届いているか見る",
              text: "Network タブとログで、Network タブにリクエストが出ているか、サーバに届いているか、DB まで進んでいるかを確認しましょう。この切り分け方は、次の「どこまで届いたか」で詳しく見ます。",
            },
            {
              title: "詳細を追う",
        ...
        },
        {
          ...
          rows: [
            [
              ...
              "新しいリクエストが無ければサーバには届いていない。5xx、または 2xx でも本文がエラーなら、原因は同時刻のサーバ側のエラーログに出ていることが多い",
            ],
            [
              "見た目だけおかしい（色、レイアウト）",
