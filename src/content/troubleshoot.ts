      ...
      blocks: [
        ...
        { type: "diagram", name: "divide", caption: "先に「どこまで届いたか」で切り分ける。" },
        {
          ...
          rows: [
            ...
            ["外部 API への接続失敗（例: ResourceAccessException）", "自社アプリは動いていることが多い。アプリサーバから外部ホスト・ポートへの TCP / curl で疎通を確認する"],
          ],
        },
      ],
    },
...
-rw-r--r-- 1 appuser appuser 48213 Aug 20 09:10 app.log`,
        ...
        {
          type: "p",
          text: "`ls -l` の出力には、パーミッションの右側に所有者名とグループ名も並びます。ログファイルを開けない、書き込めないときは、まずこの所有者・グループと、今の自分（実行しているユーザ）が誰かを確認しましょう。",
        },
        {
          type: "callout",
          kind: "trap",
...
<==      Total: 4`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "at 行があれば、フレームワークやライブラリは飛ばし、自分たちが書いたコードのパッケージ名がある行のソースを見ましょう。その値がどこでセットされたかを上流へ辿りましょう。辿り方は「ソースの読み方」の「値の源流」です。",
          link: {
            label: "値の源流",
