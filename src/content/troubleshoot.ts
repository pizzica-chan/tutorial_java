  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "症状を選ぶと、原因の当たり（クライアント・ネットワーク・サーバ）が分かります。この分類は、次の「調査手順」の「当たりのつけ方」と同じです。症状と最初に確認することの一覧は、「調査手順」の表でもまとめて見られます。",
        },
      ],
    },
    {
...
<==      Total: 4`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "ステータスコードを確認しましょう。5xx なら、同時刻のサーバ側のエラーログです。2xx でも本文がエラーなら、レスポンスの中身かアプリのログを確認しましょう。",
        },
        {
          type: "figure",
          kind: "screen",
