  ...
  lessons: [
    {
      ...
      blocks: [
        ...
        { type: "diagram", name: "scenario-layers", caption: "原因の層。仮説は、このうち1つにします。" },
        {
          ...
          items: [
            "操作、期待、実際を一文にする",
            "Network で、リクエストが飛んだか、ステータスと Content-Type を見る",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "押した瞬間の Network を見ます。新しい POST が無ければ、バックエンドにも DB にも届いていません。",
        },
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            "申請 ID 12。検証環境",
            "Network で POST /shinsei/requests/12/approve が 500",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Network で POST /shinsei/requests/12/approve は飛んでいる。500 ではない",
...
requestService.approve(id, userId);`,
        ...
        },
        {
          ...
          kind: "note",
          title: "ソースに無い文言",
          text: "画面の文が、コードにもプロパティファイルにも無いときは、Java が直書きしていません。メッセージ用のテーブル、ワークフローや認証サーバの応答 JSON を、Network と DB で見ます。応答の message をそのまま出していることがあります。",
        },
        {
          type: "callout",
          kind: "note",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "ul",
          items: [
            "Network は GET /shinsei/requests が 200、text/html",
            "画面に例外は出ていない",
        ...
        {
          type: "p",
          text: "応答は成功しています。フロントや CSS の問題でも、500 でもありません。今つないでいる DB に、ログインユーザの行があるかを見ます。",
        },
        { type: "diagram", name: "front-back", caption: "データは DB にある。コードの前に、今の DB の中身を見る。" },
        {
          type: "p",
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          type: "ul",
          items: [
            "Network で、画面を開いたときの最初のリクエスト（HTML）が終わらない、または失敗する",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "HTML が 200 なら、一覧の Controller は動いています。Network で CSS / JS の行を見ます。",
        },
        ...
        },
        {
          ...
          kind: "note",
          title: "テンプレート側のこともある",
          text: "href が /css/app.css のままで、コンテキストパス /shinsei が付いていない、というずれもあります。それでも先に Network の 404 URL を見ます。",
        },
