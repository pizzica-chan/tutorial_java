...
ls: cannot access '/var/www/html/css/': No such file or directory`,
        ...
        },
        {
          ...
          items: [
            ...
            "HTML が 200 でも CSS が 404 なら、404 になっている静的ファイルの配信設定を疑う",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "`status`、`PENDING`、`APPROVED` で全文検索しましょう。ヒットしたソースをひとつひとつ確認し、修正の要否を判断します。依頼内容から修正の要否が断定できない箇所は、依頼者へ確認する必要があるので、情報をまとめておきましょう。",
        },
        {
          type: "callout",
          kind: "note",
