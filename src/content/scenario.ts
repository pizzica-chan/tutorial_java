  ...
  lessons: [
    {
      ...
      blocks: [
        {
          type: "p",
          text: "この章は、現場でよく渡される 2 種類の依頼を想定します。どちらも最初からソースを通読しません。",
        },
        {
          type: "ul",
          items: [
            "障害対応 … 「〇〇画面で、こういう事象が起きた」だけ渡されたときの追い方",
            "改修の影響調査 … 「〇〇を変えたいので、どこを直す必要があるか」を洗い出す依頼",
          ],
        },
        ...
        },
        {
          ...
          kind: "note",
          title: "検索のやり方",
          text: "文字列検索と、型・メソッドの参照検索は別です。手がかりの選び方は「ソースの読み方」の「どこから読み始めるか」を見ましょう。詳しい手順は「処理の入口から読む」と「キーワードで探す」です。ヒットが多すぎるときは「正規表現で探す」です。",
        },
        { type: "quiz", id: "sc-how" },
      ],
    },
