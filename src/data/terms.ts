...
export const terms: TermDef[] = [
  ...
  },
  {
    term: "401 / 403",
    aliases: ["401", "403"],
    body: "ステータスコードとしては、401 を未ログイン、403 を権限が無いと読みます。ただしこの2つが実際に返るとは限らず、遷移先やエラー画面もアプリ次第です。",
  },
  {
    term: "400",
    aliases: ["400"],
  ...
  },
  {
    term: "コミット",
    aliases: ["コミット"],
    body: "「コミット」は DB と Git のどちらの文脈でも使われます。DB では、トランザクションを確定する操作です（これが無いと更新が DB に残りません）。Git では、変更を1つの単位として記録する操作です（`git commit` やコミットハッシュなど）。",
  },
  {
    term: "ロールバック",
    aliases: ["ロールバック"],
  ...
  },
  {
    term: "NAT",
    aliases: ["NAT"],
    body: "複数の端末が、外向きには1つ（または少数）の IP アドレスに見えるよう変換する仕組みです。社内ネットワークやルータでよく使われます。access.log の接続元 IP に、利用者本人ではなくこの NAT のアドレスが残ることがあります。",
  },
  {
    term: "リバースプロキシ",
    aliases: ["リバースプロキシ"],
  ...
  },
  {
    term: "SELinux",
    aliases: ["SELinux"],
    body: "Linux のセキュリティ機能の1つです。`ls -l` で見える通常のパーミッションとは別の仕組みで、ファイルやプロセスにセキュリティコンテキストというラベルを付けて制御します。RHEL 系でよく有効です。通常のパーミッションが正しくても、SELinux で拒否されることがあります。",
  },
  {
    term: "プロセス",
    aliases: ["プロセス"],
