    ...
    leaves: [
      {
        ...
        cause: ["クライアント", "サーバ"],
        causeNote: "Network タブに、操作した瞬間の新しいリクエストがあるかで分かれます",
  ...
  },
  {
    ...
    leaves: [
      ...
      },
      {
        ...
        cause: ["ネットワーク", "サーバ"],
        causeNote: "Network タブの待ち時間と、アプリのログの時刻の空きのどちらが長いかで分かれます",
  ...
  },
  {
    ...
    leaves: [
      ...
      },
      {
        ...
        cause: ["サーバ"],
        check: "遅い時間帯のログの時刻差と、同じ時間帯に動いているバッチを確認しましょう。DB へ直接つないで、DB 自体は応答するかも見ましょう。",
