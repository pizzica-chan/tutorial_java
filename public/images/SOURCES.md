...
| `screen-error-500.jpg` | 申請くん POST `/shinsei/requests/16/approve`（承認者未設定、500） |
...
| `screen-network-500.jpg` | 申請くん POST `/shinsei/requests/16/approve`（承認者未設定、500）の Network タブ |
