...
| --- | --- |
| はじめに | この教材について |
| Webの基礎 | URL、ステータスコード、Cookie など HTTP の読み方に加え、フロントエンドとバックエンドの役割分担や Ajax・JSON の扱いも身につけます |
| Javaアプリの構成 | リポジトリを開いたとき、ファイルと層の役割に加え、設定ファイルやトランザクション、共通処理の仕組みまで見渡せるようにします |
